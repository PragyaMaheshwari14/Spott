    ...
    <div className="flex items-center w-full" ref={searchRef}>
      <div className="relative flex w-full">
        ...
        <div className="flex-1 relative min-w-0">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[oklch(0.60_0.05_150)] pointer-events-none z-10" />
          <Input
        ...
        {showSearchResults && (
          <div className="
            ...
            z-50 max-h-[360px] overflow-y-auto
          ">
            {searchLoading ? (
                ...
                {searchResults.map((event) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="text-xl w-8 h-8 rounded-lg bg-[oklch(0.90_0.025_82)] flex items-center justify-center shrink-0">
                      ...
                      {event.ticketType === "free" && (
                        <Badge className="text-[10px] rounded-full bg-[oklch(0.88_0.055_150)] text-[oklch(0.30_0.10_155)] border-0 px-2 shrink-0">
                          Free
                        </Badge>
                      )}
                    </div>
