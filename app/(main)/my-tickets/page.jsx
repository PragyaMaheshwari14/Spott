      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            View and anage your event registarations
          </p>
        </div>
        ...
        {upcomingTickets?.length > 0 && (
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-vols-3 gap-6">
              {upcomingTickets.map((registartion) => (
                <EventCard
                  key={registartion._id}
                  event={registartion.event}
                  action="ticket"
                  onClick={() => setSelectedTicket(registartion)}
                  onDelete={() => handleCancelRegistration(registartion._id)}
                />
              ))}
            </div>
          </div>
